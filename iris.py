...
# Don't need the vocabulary/unique from titanic as here it is encoded already
my_feature_columns = []
...
# Train the Model. Since we need the fcn object, we write a lambda fcn to return the fcn obj. Needed because we didnt
# embed another fcn in our input fcn above
classifier.train(
...
print('\nTest set accuracy: {accuracy:0.3f}\n'.format(**eval_result))  # print our accuracy


# Allow user to input measurements and the model will output its prediction for which flower species
